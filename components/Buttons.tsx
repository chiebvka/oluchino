...
export default function Buttons(props: Props) {
    const {text} = props
  return (
    <button  className=' relative inline-block px-5 py-2 font-medium group'>
        ...
        <span className="relative text-white transition duration-200 ease-out group-hover:pt-1 group-hover:translate-y-1" >{text}</span>
  </button>
  )
}